...
app.service("avatarService", function () {
    ...
    this.headLoader = function(ctx, cb) {
        ...
        var loadTextures = function () {
            ...
            self.textures.body = loadTexture("body.jpg");
        ...
        var loadMaterials = function () {
            ...
            self.materials.body = createMaterial(self.textures.body, { bumpScale: 0, relectivity: 0, shininess: 0 });
         ...
         var initialiseAvatar = function () {
            ...
            loader.onComplete = function (e) {
                ...
                avatar.eyeGeoR.rotation.x = -110 * ToRad;
                ...
                avatar.eyeGeoL.rotation.x = -110 * ToRad;
